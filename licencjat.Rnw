...
W tej sekcji przedstawimy rozwiązanie wykorzystujące już pełną implementację schematu omówioniego w sekcji \ref{subsection-boundary-theory-finite-differences}
